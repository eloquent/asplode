 ...
 * @group core
 */
class AsplodeTest extends \Eloquent\Asplode\Test\TestCase
{
  ...
  public function testDefaultIsolator()
  {
    ...
    $this->assertInstanceOf('IcecaveStudios\Isolator\Isolator', Pops::proxy($this->_asplode)->isolator);
  }

  public function testInstall()
  {
    Phake::when($this->_isolator)->set_error_handler(Phake::anyParameters())->thenReturn(null);
